...
tldr: A database index is a key-value reverse-lookup structure that lets the query engine skip full table scans, dramatically speeding up queries at the cost of additional storage and write overhead.
---
